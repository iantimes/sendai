  ...
  I hope this helps with your project planning! Let me know if you need any clarification or have additional questions.`;
    ...
    function updatePreview() {
      ...
      try {
        ...
        console.error(error);
        showStatus('Error rendering markdown', 'error');
      }
    }
    ...
    copyFormattedBtn.addEventListener('click', () => {
      try {
        ...
        if (navigator.clipboard && navigator.clipboard.write) {
          ...
          navigator.clipboard.write([
            ...
            showStatus('Content copied! Paste directly into Gmail composer.', 'success');
      ...
      function showManualCopyInfo() {
        showStatus('Automatic copy failed. Please try manual selection or HTML copy.', 'error');
    ...
    copyHtmlBtn.addEventListener('click', () => {
      try {
        ...
        if (successful) {
          showStatus('HTML copied! Use Gmail\'s "Insert as HTML" option.', 'success');
        } else {
          showStatus('Failed to copy HTML. Try again.', 'error');
        }
      } catch (error) {
        console.error('HTML copy error:', error);
        showStatus('Error copying HTML.', 'error');
      }
    });
